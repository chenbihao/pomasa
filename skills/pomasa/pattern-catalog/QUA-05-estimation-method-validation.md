...
The `estimation-methods.md` component of STR-06 provides project-specific rules for what estimation methods are acceptable. QUA-05 provides the validation process that those methods must pass through. Both are required:

- STR-06 `estimation-methods.md` → defines *which* methods are allowed for this project
- QUA-05 → defines *how* each method must be validated before use

### Integration with QUA-02 Layered Quality Assurance

QUA-05 operates at Layer 1 (Agent self-checking) and Layer 2 (downstream cross-Agent validation):
...
- **[Methodological Guidance](./STR-06-methodological-guidance.md)**: The `estimation-methods.md` component defines project-specific acceptable methods; QUA-05 provides the validation process
- **[Embedded Quality Standards](./QUA-01-embedded-quality-standards.md)**: The Quantitative Analysis Standards dimension in QUA-01 enforces confidence tier labeling; QUA-05 defines the full validation protocol
- **[Verifiable Data Lineage](./QUA-03-verifiable-data-lineage.md)**: QUA-03 verifies that sources are real; QUA-05 verifies that the reasoning from those sources is valid — complementary, not redundant
- **[Layered Quality Assurance](./QUA-02-layered-quality-assurance.md)**: QUA-05 operates at Layers 1 and 2 of the five-layer model
